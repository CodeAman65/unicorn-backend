...
<div className="w-full max-w-md mx-auto mt-8 p-6 bg-gray-900 text-white rounded-xl shadow-lg border border-gray-800">
  ...
  <form onSubmit={handleEmailAuth} className="space-y-4">
    <div>
      ...
      <input
        ...
        className="w-full p-2.5 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        required
      />
    </div>
    ...
    {authError && (
      <p className="text-red-500 text-sm mt-1 bg-red-500/10 p-2 rounded-lg border border-red-500/20">
        {authError}
      </p>
    )}
  ...
  <p className="text-sm text-gray-400 text-center mt-4">
    {isSignUp ? "Already have an account?" : "New to AI Resume Architect?"}{" "}
    <button
